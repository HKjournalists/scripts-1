...
then 
       _disk_arn=arn:aws:sns:us-west-2:442793157362:Fame-load-disk
       _mem_arn=arn:aws:sns:us-west-2:442793157362:fame-load-memory	
       _cpu_arn=arn:aws:sns:us-west-2:442793157362:Fame-Load-ASG-High-CPU
       _network_arn=arn:aws:sns:us-west-2:442793157362:fame-load-Network
       _status_arn=arn:aws:sns:us-west-2:442793157362:fame-status
fi
